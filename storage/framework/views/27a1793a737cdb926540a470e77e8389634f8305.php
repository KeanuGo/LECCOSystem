    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Edit Signatory</div>
				<?php echo Form::open(['url' => route('signatories.update', ['id' => $signatories['id']])]);; ?>
				...
				<table class='table table-striped'>
						...
						<tr>
							...
							<?php elseif($column->COLUMN_NAME == 'id'): ?>
								...
								<div class="col-md-6">
									<?php echo e(Form::number($column->COLUMN_NAME, $signatories[$column->COLUMN_NAME], array('class' => 'form-control', 'readonly'))); ?>
							...
							<!--<div class="form-group">-->
								...
								<div class="col-md-6">
									...
									<?php elseif(strpos($column->TYPE_NAME, 'int') !== false): ?>
										<?php if($column->NULLABLE == 1): ?>
											<?php echo e(Form::number($column->COLUMN_NAME, $signatories[$column->COLUMN_NAME], array('class' => 'form-control'))); ?>
									...
									<?php elseif(strpos($column->TYPE_NAME, 'money') !== false or strpos($column->TYPE_NAME, 'decimal') !== false): ?>
										<?php if($column->NULLABLE == 1): ?>
											<?php echo e(Form::number($column->COLUMN_NAME, $signatories[$column->COLUMN_NAME], array('class' => 'form-control', 'step' => '0.01'))); ?>

										<?php else: ?>
											<?php echo e(Form::number($column->COLUMN_NAME, $signatories[$column->COLUMN_NAME], array('class' => 'form-control', 'step' => '0.01', 'required' => ''))); ?>

										<?php endif; ?>
									<?php elseif(strpos($column->TYPE_NAME, 'real') !== false): ?>
										<?php if($column->NULLABLE == 1): ?>
											<?php echo e(Form::number($column->COLUMN_NAME, $signatories[$column->COLUMN_NAME], array('class' => 'form-control', 'step' => 'any'))); ?>

										<?php else: ?>
											<?php echo e(Form::number($column->COLUMN_NAME, $signatories[$column->COLUMN_NAME], array('class' => 'form-control', 'step' => 'any', 'required' => ''))); ?>
									...
									<?php else: ?>
										<?php if($column->NULLABLE == 1): ?>
											<?php echo e(Form::text($column->COLUMN_NAME, $signatories[$column->COLUMN_NAME], array('class' => 'form-control' ))); ?>

										<?php else: ?>
											<?php echo e(Form::text($column->COLUMN_NAME, $signatories[$column->COLUMN_NAME], array('class' => 'form-control', 'required' => ''))); ?>
