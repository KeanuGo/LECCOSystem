...
<script>
	function pop_up() {
		...
		var CV_FORM = ''+
					...
					'            <tr>'+
					'                <td>Processed by:<br><br><input type="text" class="signature" list="signatories" oninput="changeDesignation(this)" default="Staff" designation_field="designation_staff"><br><input id="designation_staff" type="text" style="text-align:center;border:0;" value="Staff"></td>'+
					'                <td>Pre-Audited by:<br><br><input type="text" class="signature" list="signatories" oninput="changeDesignation(this)" default="Audit-Committee Chairman" designation_field="designation_acc"><br><input id="designation_acc" type="text" style="text-align:center;border:0;" value="Audit-Committee Chairman"></td>'+
					'            </tr>'+
					'            <tr>'+
					'                <td>Funds Available:<br><br><input type="text" class="signature" list="signatories" oninput="changeDesignation(this)" default="Treasurer" designation_field="designation_treasurer"><br><input id="designation_treasurer" type="text" style="text-align:center;border:0;" value="Treasurer"></td>'+
					'                <td>Approved by:<br><br><input type="text" class="signature" list="signatories" oninput="changeDesignation(this)" default="General Manager" designation_field="designation_gm"><br><input id="designation_gm" type="text" style="text-align:center;border:0;" value="General Manager"></td>'+
					'            </tr>'+
					'        </table>'+
					'    </div><br>'+
