    ...
    <div class="row">
        <div class="col-md-9 col-md-offset-2">
            <div class="panel panel-default">
				...
				<?php echo Form::open(['url' => route('check_voucher.store'),'onsubmit' => 'return checkCVEntries()', 'enctype'=> 'multipart/form-data']);; ?>
				...
				<table class='table table-striped'>
						...
						<tr>
							<?php if($column->COLUMN_NAME == 'cv_no' or strpos($column->COLUMN_NAME, 'created_at') !== false or strpos($column->COLUMN_NAME, 'updated_at') !== false): ?>
								<?php continue; ?>;
							<?php endif; ?>
