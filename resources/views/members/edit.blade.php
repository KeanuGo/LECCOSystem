    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
				...
				{!! Form::open(['url' => route('members.update', ['id' => $member['id']]), 'enctype'=> 'multipart/form-data']); !!}
				...
				<table class='table table-striped'>
						...
						<tr>
							...
							@elseif($column->COLUMN_NAME == 'id')
								...
								<div class="col-md-6">
									{{ Form::number($column->COLUMN_NAME, $member[$column->COLUMN_NAME], array('class' => 'form-control', 'readonly')) }}
								</div>
								@continue;
								</td>
							@endif
							<!--<div class="form-group">-->
								...
								<div class="col-md-6">
									...
									@elseif(strpos($column->TYPE_NAME, 'int') !== false)
										@if($column->NULLABLE == 1)
											{{ Form::number($column->COLUMN_NAME, $member[$column->COLUMN_NAME], array('class' => 'form-control')) }}
										@else
											{{ Form::number($column->COLUMN_NAME, $member[$column->COLUMN_NAME], array('class' => 'form-control')) }}
										@endif
									@elseif(strpos($column->TYPE_NAME, 'money') !== false or strpos($column->TYPE_NAME, 'decimal') !== false)
										@if($column->NULLABLE == 1)
											{{ Form::number($column->COLUMN_NAME, $member[$column->COLUMN_NAME], array('class' => 'form-control', 'step' => '0.01')) }}
										@else
											{{ Form::number($column->COLUMN_NAME, $member[$column->COLUMN_NAME], array('class' => 'form-control', 'step' => '0.01', 'required' => '')) }}
										@endif
									@elseif(strpos($column->TYPE_NAME, 'real') !== false)
										@if($column->NULLABLE == 1)
											{{ Form::number($column->COLUMN_NAME, $member[$column->COLUMN_NAME], array('class' => 'form-control', 'step' => 'any')) }}
										@else
											{{ Form::number($column->COLUMN_NAME, $member[$column->COLUMN_NAME], array('class' => 'form-control', 'step' => 'any', 'required' => '')) }}
										@endif
									...
									@else
										@if($column->NULLABLE == 1)
											{{ Form::text($column->COLUMN_NAME, $member[$column->COLUMN_NAME], array('class' => 'form-control' )) }}
										@else
											{{ Form::text($column->COLUMN_NAME, $member[$column->COLUMN_NAME], array('class' => 'form-control', 'required' => '')) }}
										@endif
									@endif
								</div>
								</td>
